    ...
    <>
      {modalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          <div className="modal fixed inset-0 bg-black opacity-50" onClick={() => setOpenModal(false)}></div>
          <div className={`modal-content bg-white p-0 w-2/3 md:w-1/2 xl:w-1/3 relative mt-[10%] ${contenido}`}>
