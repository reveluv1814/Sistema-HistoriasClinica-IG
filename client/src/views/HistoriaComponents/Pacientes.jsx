    ...
    <div className="p-4">
      <div className="border rounded-md p-4 shadow-md flex bg-zinc-100 dark:bg-stone-800 dark:border-stone-700">
        <div className="w-36 h-32 overflow-hidden mr-4 border">
          <a
            href={
              paciente.persona.foto
                ? import.meta.env.VITE_URL_BACK_SERVICE + paciente.persona.foto
                : "/paciente.png"
            }
            target="_blank"
          ...
          >
            <img
              ...
              onError={(e) => (e.target.src = "/paciente.png")}
        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-row flex-wrap">
            ...
            <p className="w-full md:w-1/2 lg:w-1/3 mb-2">
              <span className="font-semibold dark:text-gray-300">Edad:</span>{" "}
              {paciente.edad}
            </p>
            <p className="w-full md:w-1/2 lg:w-1/3 mb-2">
              <span className="font-semibold dark:text-gray-300">Sexo:</span>{" "}
              {paciente.sexo}
            </p>
            <p className="w-full md:w-1/2 lg:w-1/3 mb-2">
              <span className="font-semibold dark:text-gray-300">Raza:</span>{" "}
              {paciente.raza}
            </p>
            <p className="w-full md:w-1/2 lg:w-1/3 mb-2">
              <span className="font-semibold dark:text-gray-300">
