...
function DropdownProfile({
  ...
  return (
    <div className="relative inline-flex">
      ...
      >
        <img className="w-8 h-8 rounded-full" src={ig} width="32" height="32" alt="User" />
        <div className="flex items-center truncate">
          <span className="truncate ml-2 text-sm font-medium dark:text-slate-300 group-hover:text-slate-800 dark:group-hover:text-slate-200">Instituto de Genética</span>
